...
struct  ___FILEBASENAMEASIDENTIFIER____Previews: PreviewProvider {
    static var previews: some View {
        ___FILEBASENAMEASIDENTIFIER___(index: .constant(0)) {
            Text("Boie")
        }
    }
}
...
// FIXME: - 2. วิธีใช้ ในหน้า Content View ใช้ if เช็ค  index   เพื่อ แสดงหน้า View

//GeometryReader { main in
//    VStack(spacing: 0) {
//
//        BaseViewBuild(index: $index, content: {
//
//            if index == 0 {
//
//                EmptyView()
